...
| `day02_filtering_and_aggregation.html` | The walkthrough rendered with real query output — every statement plus its actual result set, generated by `_tools/sql_to_html.py`. Open directly in a browser, no database needed. |
